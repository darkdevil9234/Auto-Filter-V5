...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/moviesworld738'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/Shazam_bot_support')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('Join Us For Latest Updates', url="https://t.me/Cinemaa_Boxoffice")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            photo="https://graph.org/file/b5aab72226185cfcdf309.jpg",
